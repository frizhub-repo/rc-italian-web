...
function Hero() {
    ...
    useEffect(() => {
        dispatch(fetchAllResInfo('4e829f505a4fd3bded8b1acbb4f1248d7dede7c988cd8586a78f2aa0458ea810'));
    }, [dispatch])
    return (
            ...
            <div className="container mx-auto flex px-3 py-24 items-center justify-center flex-col">
                {loading ? 'Loading...' :
                    <img className="lg:w-1/12 max-w-xs text-light	  md:w-1/12 w-1/12 mb-10 object-cover object-center rounded" alt="hero"
                        src={`${process.env.REACT_APP_LOCAL_URL}/${restaurant?.restaurant?.logoUrl}`} />}
