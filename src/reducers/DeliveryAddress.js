import { GET_DELIVERY_ADDRESS, DELETE_DELIVERY_ADDRESS, ADD_DELIVERY_ADDRESS } from "../utils/types";
const initialState = {
  deliveryAddress: [],
};
...
export default function (state = initialState, actions) {
  switch (actions.type) {
    case ADD_DELIVERY_ADDRESS:
      return { ...state, deliveryAddress: state.deliveryAddress.concat(actions.payload) };
